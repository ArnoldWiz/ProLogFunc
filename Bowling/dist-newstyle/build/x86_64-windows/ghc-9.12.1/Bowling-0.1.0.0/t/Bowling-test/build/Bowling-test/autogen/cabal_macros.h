...
/* package Bowling-0.1.0.0 */
#ifndef VERSION_Bowling
#define VERSION_Bowling "0.1.0.0"
#endif /* VERSION_Bowling */
#ifndef MIN_VERSION_Bowling
#define MIN_VERSION_Bowling(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
...
#define CURRENT_COMPONENT_ID "Bowling-0.1.0.0-inplace-Bowling-test"
